...
const loremForm = document.querySelector(".lorem__form");
const loremAmount = document.getElementById("amount");
const loremText = document.querySelector(".lorem__text");
...
loremForm.addEventListener("submit", function (e) {
	...
	if (loremAmount.value < 10) {
		let textElement = text
			...
			.map((el) => `<p>${el}</p>`)
			.join("");
		loremText.innerHTML = textElement;
	} else {
